...
public class FamilyServiceTest {
    ...
    @Test
    public void bornChild_checkException() {
        //given
        familyService.createNewFamily(mother, father);
        //when
        try {
            ...
            familyService.bornChild(familyService.getFamilyByIndex(0), ChildName.Charlie.toString(), ChildName.George.toString());
            familyService.bornChild(familyService.getFamilyByIndex(0), ChildName.Isaac.toString(), ChildName.Thomas.toString());
            familyService.bornChild(familyService.getFamilyByIndex(0), ChildName.Freddie.toString(), ChildName.Samuel.toString());
        } catch (Exception ex) {
            //than
            Assert.assertTrue(ex instanceof FamilyOverflowException);
        }
    }
