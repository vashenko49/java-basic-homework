...
public class ConsoleApp {
    ...
    private void fillWithTestData() {
        ...
        Woman child = new Woman("Vovo", "Loulovich", 18);
        Set<String> habits = new HashSet<>();
        habits.add("very lazy");
        Pet pet = new Dog("Gogo", 2, 60, habits);
        familyController.createNewFamily(mother, father);
        familyController.createNewFamily(mother, father);
        familyController.bornChild(familyController.getFamilyByIndex(0), ChildName.Alexander.toString(), ChildName.Henry.toString());
        familyController.bornChild(familyController.getFamilyByIndex(0), ChildName.Arthur.toString(), ChildName.Archie.toString());
        familyController.addPet(0, pet);
        familyController.adoptChild(familyController.getFamilyByIndex(0), child);
        familyController.bornChild(familyController.getFamilyByIndex(1), ChildName.Arthur.toString(), ChildName.Archie.toString());
